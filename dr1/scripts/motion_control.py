...
class Commander:
    def __init__(self):
        ...
        rate = rospy.Rate(20)
        self.position_target_pub = rospy.Publisher('dr1/set_pose/position', PoseStamped, queue_size=10)
        ...
        self.svgs_sub = rospy.Subscriber('dr1/svgs', Point, self.svgsCallback)

	def svgsCallback(self, msg):
